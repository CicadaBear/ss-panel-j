...
<head>
    ...
    <!-- Font Awesome Icons -->
    <link href="${ctxStatic}//cdn.bootcss.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <!-- Theme style -->
    <link href="${ctxStatic}/assets/public/css/AdminLTE.min.css" rel="stylesheet" type="text/css"/>
    <link href="${ctxStatic}/assets/public/css/blue.css" rel="stylesheet" type="text/css"/>
